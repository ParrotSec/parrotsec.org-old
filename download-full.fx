                ...
                <ul class="list-group list-group-flush text-center">
                 ...
                 <li class="list-group-item"><i class="icon-ok text-info"></i>',$lang['download-full-8'],PARROT_FULL_SIZE_64,'</li>
    						...
    						<div class="panel-footer">
    							<a class="btn btn-lg btn-block btn-info" href="https://cdimage.parrotsec.org/parrot/iso/3.10.1/Parrot-security-3.10.1_amd64.iso">',$lang['index-3'],'</a>
    						</div>
                <div class="panel-footer">
    							<a class="btn btn-lg btn-block btn-info" target="_blank" href="https://cdimage.parrotsec.org/parrot/iso/3.10.1/Parrot-security-3.10.1_amd64.iso.mirrorlist">',$lang['download-full-9'],'</a>
    						</div>
                <div class="panel-footer">
    							<a class="btn btn-lg btn-block btn-info" href="https://cdimage.parrotsec.org/parrot/iso/3.10.1/Parrot-security-3.10.1_amd64.iso.torrent">',$lang['download-full-10'],'</a>
    						</div>
                <div class="panel-footer">
                  <a class="btn btn-lg btn-block btn-info" target="_blank" href="https://cdimage.parrotsec.org/parrot/iso/3.10.1/signed-hashes.txt">',$lang['download-full-11'],'</a>
    						</div>
    					</div>
            </div>
              ...
              <div class="panel download panel-blue">
                ...
                <ul class="list-group list-group-flush text-center">
                  ...
                  <li class="list-group-item"><i class="icon-ok text-info"></i>',$lang['download-full-8'],PARROT_FULL_SIZE_32,'</li>
    						...
    						<div class="panel-footer">
    							<a class="btn btn-lg btn-block btn-info" href="https://cdimage.parrotsec.org/parrot/iso/3.10.1/Parrot-security-3.10.1_i386.iso">',$lang['index-3'],'</a>
    						</div>
                <div class="panel-footer">
    							<a class="btn btn-lg btn-block btn-info" target="_blank" href="https://cdimage.parrotsec.org/parrot/iso/3.10.1/Parrot-security-3.10.1_i386.iso.mirrorlist">',$lang['download-full-9'],'</a>
    						</div>
                <div class="panel-footer">
    							<a class="btn btn-lg btn-block btn-info" href="https://cdimage.parrotsec.org/parrot/iso/3.10.1/Parrot-security-3.10.1_i386.iso.torrent">',$lang['download-full-10'],'</a>
    						</div>
                <div class="panel-footer">
                  <a class="btn btn-lg btn-block btn-info" target="_blank" href="https://cdimage.parrotsec.org/parrot/iso/3.10.1/signed-hashes.txt">',$lang['download-full-11'],'</a>
    						</div>
