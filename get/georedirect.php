...
if($mirror=="auto");
{
        switch ($_SERVER["HTTP_CF_IPCOUNTRY"])
        {
                ...
                case "BN":
                	$amirror=array("cloudflare","lagoon","internode");
                        ...
                        break;
                case "BG":
                	$amirror=array("cloudflare","netix");
                        $mirror=$amirror[array_rand($amirror)];
                        break;
                case "BF":
                ...
                case "CZ":
                	$amirror=array("ignum");
                        ...
                        break;
                case "DK":
                	$amirror=array("nluug","onet","umu","rwth-aachen");
                        $mirror=$amirror[array_rand($amirror)];
                        break;
                case "DJ":
                	$amirror=array("cloudflare","aptus","tenet");
		...
		case "ER":
                ...
                case "FI":
                        ...
                        break;
                case "FR":
                        $amirror=array("heanet","dasa1-euro","frozenbox","freefr","freefr","rwth-aachen","esslingen");
                        $mirror=$amirror[array_rand($amirror)];
                        break;
                case "GF":
                        $amirror=array("ufpr","nbtelecom");
                ...
                case "GH":
                        ...
                        break;
                case "GI":
                        $amirror=array("rwth-aachen","garr","nluug","heanet");
                        $mirror=$amirror[array_rand($amirror)];
                        break;
                case "GR":
                        $amirror=array("garr","onet","rwth-aachen");
                        $mirror=$amirror[array_rand($amirror)];
                        break;
                case "GL":
		...
		case "IT":
                ...
                case "PL":
                        ...
                        break;
                case "PT":
                        $amirror=array("heanet","rwth-aachen","esslingen","garr");
                        $mirror=$amirror[array_rand($amirror)];
                        break;
                case "PR":
                        $amirror=array("jmu","clarkson");
		...
		case "SD":
                        ...
                        break;
                case "ES":
                        $amirror=array("cloudflare","heanet","nluug","garr");
                        $mirror=$amirror[array_rand($amirror)];
                        break;
                case "LK":
