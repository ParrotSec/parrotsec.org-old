            ...
            <div class="col-lg-4 col-md-4 text-center">
              <div class="panel download panel-blue">
                ...
                <ul class="list-group list-group-flush text-center">
                  ...
                  <li class="list-group-item"><i class="icon-ok text-info"></i>Size: 5.7GB</li>
    						</ul>
    						<div class="panel-footer">
    							<a class="btn btn-lg btn-block btn-info" href="https://download.parrot.sh/parrot/iso/<?php echo CONFIG_SYSTEM_VERSION; ?>/Parrot-security-<?php echo CONFIG_SYSTEM_VERSION; ?>_virtual.ova"><?php echo $lang['index-3']; ?></a>
    						</div>
                <div class="panel-footer">
    							<a class="btn btn-lg btn-block btn-info" target="_blank" href="https://download.parrot.sh/parrot/iso/<?php echo CONFIG_SYSTEM_VERSION; ?>/Parrot-security-<?php echo CONFIG_SYSTEM_VERSION; ?>_virtual.ova.mirrorlist"><?php echo $lang['download-security-9']; ?></a>
    						</div>
                <div class="panel-footer">
    							<a class="btn btn-lg btn-block btn-info" href="https://download.parrot.sh/parrot/iso/<?php echo CONFIG_SYSTEM_VERSION; ?>/Parrot-security-<?php echo CONFIG_SYSTEM_VERSION; ?>_virtual.ova.torrent"><?php echo $lang['download-security-10']; ?></a>
    						</div>
                <div class="panel-footer">
                  <a class="btn btn-lg btn-block btn-info" target="_blank" href="https://download.parrot.sh/parrot/iso/<?php echo CONFIG_SYSTEM_VERSION; ?>/signed-hashes.txt"><?php echo $lang['download-security-11']; ?></a>
    						</div>
