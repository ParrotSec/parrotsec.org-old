        ...
        <div class="container">
            ...
            <div class="col-lg-3 col-md-3 col-md-offset-2 col-lg-offset-2 text-center">
              <div class="panel download panel-blue">
                ...
                <div class="panel-footer">
    							<a class="btn btn-lg btn-block btn-info" href="https://cdimage.parrotsec.org/parrot/iso/<?php echo CONFIG_SYSTEM_VERSION; ?>/Parrot-all-<?php echo CONFIG_SYSTEM_VERSION; ?>.torrent"><?php echo $lang['download-security-10']; ?></a>
    						</div>
                <div class="panel-footer">
