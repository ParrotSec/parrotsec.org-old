...
const CONFIG_SITE_URL = 'http://tlenmager.pw/parrot/';
const CONFIG_SITE_URL_STATIC_RESOURCES = 'http://tlenmager.pw/parrot/';
const CONFIG_SITE_AUTOR = 'Lorenzo Faletra';
const CONFIG_SYSTEM_VERSION = '3.9';
...
const PARROT_PICO_ARCH = 'x86_32';
const PARROT_PICO_SIZE = '680MB';
const PARROT_PICO_INF  = 'Enlightenment 21';

const PARROT_SOURCE_EXT = 'tar.xz';
const PARROT_SOURCE_SIZE = '6.5GB';
