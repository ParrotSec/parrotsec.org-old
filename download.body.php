                            ...
                            <div class="mdl-grid mdl-grid--no-spacing">
                                <div class="mdl-cell--6-col">
                                    ...
                                    <form target="_blank" onSubmit="this.action = document.getElementById('full32').value">
                                        <?php
                                        mirrorSelector("3.5/Parrot-full-3.5_i386.iso", "full32");
                                        ?>
                                        <br>
                                        <br>
                                ...
                                <div class="mdl-cell--6-col">
                                    ...
                                    <form target="_blank" onsubmit="this.action = document.getElementById('full64').value">
                                        <?php
                                        mirrorSelector("3.5/Parrot-full-3.5_amd64.iso", "full64");
                                        ?>
                                        <br>
                                        <br>
                                        <input type="text" style="display:none" name="get" value="1" readonly>
                            ...
                            <div class="mdl-grid mdl-grid--no-spacing">
                                <div class="mdl-cell--6-col">
                                    ...
                                    <form target="_blank" onSubmit="this.action = document.getElementById('lite32').value">
                                        <?php
                                        mirrorSelector("3.5/Parrot-lite-3.5_i386.iso", "lite32");
                                        ?>
                                        <br>
                                        <br>
                                        <input type="text" style="display:none" name="get" value="1" readonly>
                                ...
                                <div class="mdl-cell--6-col">
                                    ...
                                    <form target="_blank" onsubmit="this.action = document.getElementById('lite64').value">
                                        <?php
                                        mirrorSelector("3.5/Parrot-lite-3.5_amd64.iso", "lite64");
                                        ?>
                                        <br>
                                        <br>
                                        <input type="text" style="display:none" name="get" value="1" readonly>
            ...
            <section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp">
                <div class="mdl-card mdl-cell mdl-cell--12-col section--center">
                    ...
                    <div id="netboot" class="mdl-card__supporting-text" align="center">
                        ...
                        <a href="http://mirrordirector.archive.parrotsec.org/parrot/pool/iso/3.5/Parrot-netboot-3.5_i386.iso" target="_blank" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color--accent mdl-color-text--accent-contrast button-margin">Netinstall 32bit</a>
                        <a href="http://mirrordirector.archive.parrotsec.org/parrot/pool/iso/3.5/Parrot-netboot-3.5_amd64.iso" target="_blank" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color--accent mdl-color-text--accent-contrast button-margin">Netinstall 64bit</a><br><br>
                    </div>
                    <div class="mdl-card__supporting-text" align="center">
                    ...
                    <div class="mdl-card__supporting-text" align="center">
                        ...
                        <form target="_blank" onsubmit="this.action = document.getElementById('studio').value">
                            <?php
                            mirrorSelector("3.5/Parrot-studio-3.5_amd64.iso", "studio");
                            ?>
                            <br>
                            <br>
                            <input type="text" style="display:none" name="get" value="1" readonly>
