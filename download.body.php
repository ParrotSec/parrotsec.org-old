                    ...
                    <div class="mdl-card__supporting-text mdl-grid mdl-grid--no-spacing">
                        ...
                        <div class="section__text mdl-cell mdl-cell--10-col-desktop mdl-cell--6-col-tablet mdl-cell--3-col-phone">
                            ...
                            <div class="mdl-grid mdl-grid--no-spacing">
                                ...
                                <div class="mdl-cell--6-col">
                                    <h4>64bit</h4>
                                    <a href="https://mirrordirector.archive.parrotsec.org/parrot/iso/<?php echo $version; ?>/Parrot-full-<?php echo $version; ?>_amd64.iso.mirrorlist" onclick="_paq.push(['trackGoal', 3]);" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color--accent mdl-color-text--accent-contrast button-fixed-width" style="color: #060606;background:#00a000;">Download</a>
                                    <a href="https://mirrordirector.archive.parrotsec.org/parrot/iso/<?php echo $version; ?>/Parrot-full-<?php echo $version; ?>_amd64.iso.torrent" style="color:#060606;background:#00a0a0;" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color--accent mdl-color-text--accent-contrast button-fixed-width">Torrent</a><br><br>
                                    <a href="https://archive.parrotsec.org/parrot/iso/<?php echo $version; ?>/signed-hashes.txt" target="_blank" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color--accent mdl-color-text--accent-contrast button-fixed-width">Hashes</a><br><br>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mdl-card__supporting-text mdl-grid mdl-grid--no-spacing">
                        ...
                        <div class="section__text mdl-cell mdl-cell--10-col-desktop mdl-cell--6-col-tablet mdl-cell--3-col-phone">
                            ...
                            <div class="mdl-grid mdl-grid--no-spacing">
                                <div class="mdl-cell--6-col">
                                    <h4>32bit</h4>
                                    <a href="https://mirrordirector.archive.parrotsec.org/parrot/iso/<?php echo $version; ?>/Parrot-lite-<?php echo $version; ?>_i386.iso.mirrorlist" onclick="_paq.push(['trackGoal', 7]);" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color--accent mdl-color-text--accent-contrast button-fixed-width" style="color: #060606;background:#00a000;">Download</a>
                                    <a href="https://mirrordirector.archive.parrotsec.org/parrot/iso/<?php echo $version; ?>/Parrot-lite-<?php echo $version; ?>_i386.iso.torrent" style="color:#060606;background:#00a0a0;" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color--accent mdl-color-text--accent-contrast button-fixed-width">Torrent</a><br><br>
                                    <a href="https://archive.parrotsec.org/parrot/iso/<?php echo $version; ?>/signed-hashes.txt" target="_blank" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color--accent mdl-color-text--accent-contrast button-fixed-width">Hashes</a><br><br>
                                </div>
                                <div class="mdl-cell--6-col">
                                    <h4>64bit</h4>
                                    <a href="https://mirrordirector.archive.parrotsec.org/parrot/iso/<?php echo $version; ?>/Parrot-lite-<?php echo $version; ?>_amd64.iso.mirrorlist" onclick="_paq.push(['trackGoal', 7]);" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color--accent mdl-color-text--accent-contrast button-fixed-width" style="color: #060606;background:#00a000;">Download</a>
                                    <a href="https://mirrordirector.archive.parrotsec.org/parrot/iso/<?php echo $version; ?>/Parrot-lite-<?php echo $version; ?>_amd64.iso.torrent" style="color:#060606;background:#00a0a0;" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color--accent mdl-color-text--accent-contrast button-fixed-width">Torrent</a><br><br>
                                    <a href="https://archive.parrotsec.org/parrot/iso/<?php echo $version; ?>/signed-hashes.txt" target="_blank" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color--accent mdl-color-text--accent-contrast button-fixed-width">Hashes</a><br><br>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mdl-card__supporting-text mdl-grid mdl-grid--no-spacing">
                        ...
                        <div class="section__text mdl-cell mdl-cell--10-col-desktop mdl-cell--6-col-tablet mdl-cell--3-col-phone">
                            <div class="mdl-grid mdl-grid--no-spacing">
                                <div class="mdl-cell--6-col">
                                    <h4>Raspberry Pi</h4>
                                    <a href="https://mirrordirector.archive.parrotsec.org/parrot/iso/arm/parrotsec-3.4-armhf-rpi-1/index.html" onclick="_paq.push(['trackGoal', 10]);" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color--accent mdl-color-text--accent-contrast button-fixed-width" style="color: #060606;background:#00a000;">Download</a>
                                </div>
                                <div class="mdl-cell--6-col">
                                    <h4>Generic Rootfs</h4>
                                    <a href="https://mirrordirector.archive.parrotsec.org/parrot/iso/arm/parrotsec-3.4-armhf-1/index.html" onclick="_paq.push(['trackGoal', 10]);" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color--accent mdl-color-text--accent-contrast button-fixed-width" style="color: #060606;background:#00a000;">Download</a>
            ...
            <section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp">
                <div class="mdl-card mdl-cell mdl-cell--12-col section--center">
                    ...
                    <div class="mdl-card__supporting-text" align="center">
                        ...
                        <a href="https://mirrordirector.archive.parrotsec.org/parrot/iso/<?php echo $version; ?>/Parrot-studio-<?php echo $version; ?>_amd64.iso.mirrorlist" onclick="_paq.push(['trackGoal', 13]);" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color--accent mdl-color-text--accent-contrast button-fixed-width" style="color: #060606;background:#00a000;">Download</a>
                        <a href="https://mirrordirector.archive.parrotsec.org/parrot/iso/<?php echo $version; ?>/Parrot-studio-<?php echo $version; ?>_amd64.iso.torrent" style="color:#060606;background:#00a0a0;" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color--accent mdl-color-text--accent-contrast button-fixed-width">Torrent</a><br><br>
                        <a href="https://archive.parrotsec.org/parrot/iso/<?php echo $version; ?>/signed-hashes.txt" target="_blank" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color--accent mdl-color-text--accent-contrast button-fixed-width">Hashes</a><br><br>
                    </div>
                </div>
            </section>
