              ...
              <div class="panel download panel-blue">
                ...
                <ul class="list-group list-group-flush text-center">
                  ...
                  <li class="list-group-item"><i class="icon-ok text-info"></i><?php echo $lang['download-home-9'] . " " . PARROT_LITE_SIZE_64; ?></li>
    						...
    						<div class="panel-footer">
    							<a class="btn btn-lg btn-block btn-info" href="https://cdimage.parrotsec.org/parrot/iso/3.11/Parrot-home-3.11_amd64.iso"><?php echo $lang['index-3']; ?></a>
    						</div>
                <div class="panel-footer">
    							<a class="btn btn-lg btn-block btn-info" target="_blank" href="https://cdimage.parrotsec.org/parrot/iso/3.11/Parrot-home-3.11_amd64.iso.mirrorlist"><?php echo $lang['download-home-10']; ?></a>
    						</div>
                <div class="panel-footer">
    							<a class="btn btn-lg btn-block btn-info" href="https://cdimage.parrotsec.org/parrot/iso/3.11/Parrot-home-3.11_amd64.iso.torrent"><?php echo $lang['download-home-11']; ?></a>
    						</div>
                <div class="panel-footer">
                  <a class="btn btn-lg btn-block btn-info" target="_blank" href="https://cdimage.parrotsec.org/parrot/iso/3.11/signed-hashes.txt"><?php echo $lang['download-home-12']; ?></a>
    						</div>
    					</div>
            </div>
              ...
              <div class="panel download panel-blue">
                ...
                <ul class="list-group list-group-flush text-center">
                  ...
                  <li class="list-group-item"><i class="icon-ok text-info"></i><?php echo $lang['download-home-9'] . " " . PARROT_LITE_SIZE_32; ?></li>
    						...
    						<div class="panel-footer">
    							<a class="btn btn-lg btn-block btn-info" href="https://cdimage.parrotsec.org/parrot/iso/3.11/Parrot-home-3.11_i386.iso"><?php echo $lang['index-3']; ?></a>
    						</div>
                <div class="panel-footer">
    							<a class="btn btn-lg btn-block btn-info" target="_blank" href="https://cdimage.parrotsec.org/parrot/iso/3.11/Parrot-home-3.11_i386.iso.mirrorlist"><?php echo $lang['download-home-10']; ?></a>
    						</div>
                <div class="panel-footer">
    							<a class="btn btn-lg btn-block btn-info" href="https://cdimage.parrotsec.org/parrot/iso/3.11/Parrot-home-3.11_i386.iso.torrent"><?php echo $lang['download-home-11']; ?></a>
    						</div>
                <div class="panel-footer">
                  <a class="btn btn-lg btn-block btn-info" target="_blank" href="https://cdimage.parrotsec.org/parrot/iso/3.11/signed-hashes.txt"><?php echo $lang['download-home-12']; ?></a>
    						</div>
