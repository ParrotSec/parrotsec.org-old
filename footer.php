<footer id="footer">
    <div class="container-fluid">
        <div class="row">
            <div class="col-xs-6 col-sm-3 column">
                ...
                <ul class="list-unstyled">
                  <li><a href="https://docs.parrotsec.org/about">About</a></li>
                  <li><a href="https://docs.parrotsec.org/terms">Terms and Conditions</a></li>
        ...
        <div class="blue-triangular-division wow slideInDown"></div>
          <p class="text-center">© Lorenzo Faletra 2013-2017 Some Rights Reserved</span> - <a target="_blank" href="https://www.gnu.org/licenses/gpl-3.0.en.html">GNU/GPL v3</a></p>
