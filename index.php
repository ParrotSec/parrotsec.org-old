...
<header id="first">
    <div class="header-content">
        <div class="inner">
            ...
            <a href="<?php echo CONFIG_SITE_URL_STATIC_RESOURCES ."download.php"; ?>" class="btn btn-primary btn-xl">Download</a> &nbsp;
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-4 text-center">
                <div class="feature">
                    <img src="<?php echo CONFIG_SITE_URL_STATIC_RESOURCES . "img/security.png"; ?>" width="60" height="60" />
                    <h3>Security</h3>
            ...
            <div class="col-lg-4 col-md-4 text-center">
                <div class="feature">
                    <img src="<?php echo CONFIG_SITE_URL_STATIC_RESOURCES . "img/privacy.png";?>" width="60" height="60" />
                    <h3>Privacy</h3>
            ...
            <div class="col-lg-4 col-md-4 text-center">
                <div class="feature">
                    <img src="<?php echo CONFIG_SITE_URL_STATIC_RESOURCES . "img/develop.png"; ?>" width="55" height="55" />
                    <h3>Development</h3>
    ...
    <div class="row">
        <div class="col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
            ...
            <div class="media wow fadeInRight">
                ...
                <div class="media-right"><img src="<?php echo CONFIG_SITE_URL_STATIC_RESOURCES . "img/shield.png"; ?>" width="100" /></div>
            </div>
            <hr>
            <div class="media wow fadeInLeft">
                <h3>Free (as in freedom)</h3>
                <div class="media-left"><a href="#alertModal" data-toggle="modal" data-target="#alertModal"><img src="<?php echo CONFIG_SITE_URL_STATIC_RESOURCES . "img/gpl.png"; ?>" width="100" /></a></div>
            ...
            <div class="media wow fadeInRight">
                ...
                <div class="media-right"><img src="<?php echo CONFIG_SITE_URL_STATIC_RESOURCES . "img/lightweight.png"; ?>" width="100" /></div>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row no-gutter">
            <div class="col-lg-4 col-sm-6">
                <a href="#galleryModal" class="gallery-box" data-toggle="modal" data-src="./screenshots/01.jpg">
                    ...
                    <div class="gallery-box-caption"><div class="gallery-box-content"><i class="icon-lg ion-ios-search"></i></div></div>
                </a>
            </div>
            <div class="col-lg-4 col-sm-6">
